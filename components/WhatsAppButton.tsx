...
export default function WhatsAppButton() {
  ...
  return (
    ...
    >
      {/* Tooltip label */}
      <div
        className={`bg-stone-900 text-stone-100 text-sm px-4 py-2 rounded-sm shadow-xl transition-all duration-400 whitespace-nowrap ${
          showLabel ? "opacity-100 translate-x-0" : "opacity-0 translate-x-4 pointer-events-none"
        }`}
        style={{ border: "1px solid #2a2a2a" }}
      >
        ¿Listo para reservar? 🍽️
      </div>
      ...
      <a
        ...
        className="wa-pulse w-14 h-14 rounded-full flex items-center justify-center shadow-2xl transition-transform hover:scale-110 active:scale-95"
